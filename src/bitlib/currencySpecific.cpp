...
bool usesCashAddress()
{
#ifdef CURRENCY_BITCOINCASH
	return true;
#elif defined CURRENCY_BITCOINCASH_SLP
	return true;
#else
	return false;
#endif
...
#elif defined CURRENCY_BITCOINCASH_SLP
	return "0488ADE4";		//Bitcoin cash SLP	
...
#elif defined CURRENCY_BITCOINCASH_SLP
	return "0488B21E";		//Bitcoin cash SLP
#elif defined CURRENCY_VERTCOIN
	return "00000000";		//TBD
#elif defined CURRENCY_REDDCOIN
	return "00000000";		//TBD

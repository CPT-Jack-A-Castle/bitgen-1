...
void printUsage()
{
	...
	std::cout << "One-time-pad: " << std::endl;
	std::cout << "otpgen otp otpdir" << std::endl;
	//std::cout << " addxor removexor readxor" << std::endl;
	std::cout << std::endl;

	std::cout << "Transactions: " << std::endl;
	std::cout << "transaction savetrans decodetrans parsetrans transinputhashes savescript decodescript runtrans" << std::endl;
	...
	std::cout << "Email: bitgen@tutanota.com" << std::endl;
	std::cout << std::endl;
}

...
retval1 = os.system("../bitgen-btc transaction 6534534534534534534555545353453458345835834853845834853845834203 0 KxKuBVQ4pBdAyPauWDMrdG94EGyS8MXaYGxe61eZzQFg41YG4Duh 0 out 17QfnvRhxHeP6sR79PaUju8DCBeBkNdah9 4.999 extra fixednounce")
if retval1 != 0:
	print "btc test 3 error"
	sys.exit()


#btc_8A73C284053522460DB7397FFA30491D87A76BCFC989B56D801B08F5E06E6D07.trans"):
if not os.path.isfile("btc_AD042E22BE9D2BBA1B9BB79ABBEDDEDD6D73BA4DB3274DBAF8758EB03CD23C81.trans"):

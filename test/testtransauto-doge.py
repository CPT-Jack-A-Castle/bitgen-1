...
retval1 = os.system("../bitgen-doge transaction 6534534534534534534555545353453458345835834853845834853845834203 0 QPu3vZQeYBRMi8hvRA2nQTpTAV2ZjzBDKbuN4Jejw1AFDkDHRy5R 0 out DGLN6k8R4UoM2Yp5uMEsdz6vaHCVjdknJG 4.999 extra fixednounce")
if retval1 != 0:
	print "test 3 error"
	sys.exit()


if not os.path.isfile("doge_C5CE493693B6F995B6B48018204F829BC28516F962EC6D00A74FB9705AE994DA.trans"):

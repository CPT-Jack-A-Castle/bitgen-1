...
retval1 = os.system("../bitgen-ftc transaction 6534534534534534534555545353453458345835834853845834853845834203 0 N3T9EtgmuAUQTsKozaoJARcUVkcgTjxsLVjxYMHk4ouLi8WFQufu 0 out 6to6GkC5BN5h5cXdoqAWLi27aDirrNWfsc 4.999 extra fixednounce")
if retval1 != 0:
	print "test 3 error"
	sys.exit()


if not os.path.isfile("ftc_AD67B6E3D6D2E0C804048B994BE2BADC4C92977A0DCA858428DA870B52A8CC1E.trans"):

...
retval1 = os.system("../bitgen-ltc transaction 6534534534534534534555545353453458345835834853845834853845834203 0 T3JUdwMyRui7837c1MMfncLVpCDsRMywXM9F3DREPmtduTyfeNgx 0 out LeHocymWW3RVPEY7Ft7iuxb3UDWmC7coMs 4.999 extra fixednounce")
if retval1 != 0:
	print "test 3 error"
	sys.exit()


if not os.path.isfile("ltc_8F91DD9B5330A215EB36CEA5B0201CF834B0B2474EDF4350A6735C42F9675414.trans"):

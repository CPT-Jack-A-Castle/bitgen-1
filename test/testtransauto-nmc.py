...
retval1 = os.system("../bitgen-nmc transaction 6534534534534534534555545353453458345835834853845834853845834203 0 L1k2Gr6tkgVieJdJuvriCVC22pL15aDm38vVTjkqhhG1eDrLLLJS 0 out NJU8aWDJoxaamDhPxCFsRZrHKqkRmscTtW 4.999 extra fixednounce")
if retval1 != 0:
	print "test 3 error"
	sys.exit()


if not os.path.isfile("nmc_98C43222183881112D131C3EA22CB3294061B8B9023A1EB787473D08D0BE81FA.trans"):

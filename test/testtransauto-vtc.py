...
retval1 = os.system("../bitgen-vtc transaction 6534534534534534534555545353453458345835834853845834853845834203 0 WZ6urxhWtuQCJtgs5nFnkHVdahVfnx9Cx72yScD4gUEYkSkkvErJ 0 out VpLqqrw2ArJYPpTmVsFfkRtr9KMexBStqq 4.999 extra fixednounce")
if retval1 != 0:
	print "test 3 error"
	sys.exit()


if not os.path.isfile("vtc_DEF3F4946D1D80562A4D8485BBE234438D5BE7517DFD8F361DCCCECCEAFB2DDB.trans"):
	print "Got a test 3 file error"
	sys.exit()
